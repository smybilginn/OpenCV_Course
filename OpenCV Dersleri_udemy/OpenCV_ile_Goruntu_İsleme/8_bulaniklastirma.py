...
* Gürültüyü gidermek için kullanışlıdır. Aslında görüntüden yüksek frekanslı içeriği kaldırır.
* OpenCV, üç ana tür bulanıklaştırma tekniği sağlar:
    - Ortalama bulanıklaştırma:
        - Bir görüntünün normalleştirilmiş bir kutu filtresiyle sarılamsıyla yapılır
    ...
    - Medyan bulanıklaştırma:
        - Çekirdek alanı altındaki tüm piksellerin medyanını alır ve merkezi öğre bu medyan değerle değiştirilir.
